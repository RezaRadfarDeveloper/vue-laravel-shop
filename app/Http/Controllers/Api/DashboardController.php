...
class DashboardController extends Controller
{
    ...
    return Order::query()
      ->select(['o.id', 'o.total_price','c.first_name', 'c.last_name', 'o.created_at',DB::raw('COUNT(oi.id) AS count')])
      ->from('orders AS o')
      ...
      ->groupBy('o.id', 'o.total_price', 'o.created_at','c.first_name', 'c.last_name')
      ->get();
    }
}
